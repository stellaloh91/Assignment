...
```{r, layout="l-body-outset", fig.width=5.5, fig.height=5, fig.cap="Figure: Bar Chart of loyalty card transaction volume per location cross-linked with line chart"}
...
```{r, layout="l-body-outset", fig.width=5.5, fig.height=5, fig.cap="Figure: Bar Chart of credit card transaction volume per location cross-linked with line chart"}
...
```{r, layout="l-body-outset", fig.width=7.5, fig.height=5.5, fig.cap="Figure: Heatmap showing difference in transaction volume per location"}
...
```{r, fig.cap="Figure: Bar Chart of loyalty card transaction volume per location by day of week cross-linked with datatable"}
...
```{r, fig.cap="Figure: Bar Chart of credit card transaction volume per location by day of week and timegroup, cross-linked with datatable"}
...
```{r, fig.cap="Figure: Interactive map"}
##Plotting GPS paths
...
```{r, layout="l-body-outset", fig.width=6, fig.height=20, fig.cap="Figure: Facet map"}
##Facet map
gps_path_selected <- gps_path_cleaned %>%
  filter(hour == 12)
...
```{r, layout="l-body-outset", fig.width=8, fig.height=7, fig.cap="Figure: Interactivet network graph"}
##Interactive viz
...
```{r, layout="l-body-outset", fig.width=12, fig.height=10, fig.cap="Figure: Facet map of day by timegroup"}
##Facet
cc_edges <- cc_edges %>%
  filter(day == 6)
