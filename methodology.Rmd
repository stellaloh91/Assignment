...
DT::datatable(loyalty_cc_match, extensions='Scroller', filter = "top", fillContainer = T, options = list(scrollX=TRUE, autoWidth=TRUE, scroller=TRUE)) %>% formatDate(4, method = 'toLocaleDateString')
```
