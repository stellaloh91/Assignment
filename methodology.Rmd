...
```{r, layout="l-body-outset", fig.width=5.5, fig.height=5, fig.cap="Bar Chart of loyalty card transaction volume per location cross-linked with line chart"}
...
```{r, layout="l-body-outset", fig.width=5.5, fig.height=5, fig.cap="Bar Chart of credit card transaction volume per location cross-linked with line chart"}
...
```{r, layout="l-body-outset", fig.width=7.5, fig.height=5.5, fig.cap="Heatmap showing difference in transaction volume per location"}
...
```{r, fig.cap="Bar Chart of loyalty card transaction volume per location by day of week cross-linked with datatable"}
...
```{r, fig.cap="Bar Chart of credit card transaction volume per location by day of week and timegroup, cross-linked with datatable"}
...
```{r, layout="l-body-outset", fig.width=6, fig.height=20, fig.cap="Facet map"}
##Facet map
gps_path_selected <- gps_path_cleaned %>%
  filter(hour == 12)
