...
### Missing values
```{r, tidy.opts=list(width.cutoff=55),tidy=TRUE, layout="l-body-outset", fig.width=5.5, fig.height=5, fig.cap="Loyalty card- Percentage of missing values"}
##loyalty card
...
```{r, tidy.opts=list(width.cutoff=55),tidy=TRUE, layout="l-body-outset", fig.width=5.5, fig.height=5, fig.cap="Credit card- Percentage of missing values"}
##credit card
...
```{r, tidy.opts=list(width.cutoff=50),tidy=TRUE, layout="l-body-outset", fig.width=5.5, fig.height=5, fig.cap="Location data- Percentage of missing values"}
##location data
...
```{r, tidy.opts=list(width.cutoff=60),tidy=TRUE, fig.cap="Table: Employees with no assigned car"}
...
```{r, tidy.opts=list(width.cutoff=55),tidy=TRUE, fig.cap="Cars with no assigned employees"}
...
```{r, tidy.opts=list(width.cutoff=55),tidy=TRUE, fig.cap="Log transformed distribution of loyalty card spending"}
##loyalty card
...
```{r, tidy.opts=list(width.cutoff=60),tidy=TRUE, fig.cap="Log transformed distribution of credit card spending"}
##credit card
