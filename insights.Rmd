...
```{r, fig.cap="Distinct employee names"}
...
```{r, fig.cap="Distinct loyalty card numbers"}
##distinct loyalty cards
DT::datatable(distinct_loyalty, options = list(columnDefs = list(list(className = 'dt-center', targets = 0:2, width = '20%'))))
```

```{r, fig.cap="Distinct credit card numbers"}
...
```{r, fig.cap="Employees with no assigned car"}
...
```{r, fig.cap="CarID with no assigned employee"}
...
2) As the tourist map only provides information about certain tourist attractions and not all the locations in Abila, we are unable to match the full list of locations from trajectory as seen in the map view to the transactions occurring in locations which are not reflected in tourist map (e.g. Abila Zacharo). This may result in **incorrect matching as it is more of a guesswork** as not all locations visited in the GPS trajectory can be mapped to an actual transaction.
...
```{r, layout="l-body-outset", fig.width=8, fig.height=5, fig.cap="Facet graph of CarID 1 at time 2100-2400 by day"}
##Facet map- by day
gps_path_selected <- gps_path_cleaned %>%
...
```{r, layout="l-body-outset", fig.width=12, fig.height=10, fig.cap="Datatable of credit card transactions"}
...
```{r, layout="l-body-outset", fig.width=6, fig.height=5, fig.cap="Interactive map of CarID 1 on day 13, timegroup 1300-1600"}
##Plotting GPS paths- interactive map
gps_path_selected <- gps_path_cleaned %>%
...
```{r, layout="l-body-outset", fig.width=12, fig.height=10, fig.cap="Facet graph of all cars moving at time 2200 - 2300 on day 10"}
##Facet map- by id
gps_path_selected <- gps_path_cleaned %>%
...
```{r, layout="l-body-outset", fig.width=6, fig.height=2, fig.cap="Facet graph of all cars moving at time 0000 on day 11"}
##Facet map- by id
gps_path_selected <- gps_path_cleaned %>%
...
```{r, fig.cap="Interactive graph of CarID16 at time 2300 on day 10"}
##Interactive map
gps_path_selected <- gps_path_cleaned %>%
...
```{r, fig.cap="Interactive graph of CarID 16 at time 0300 on day 11"}
##Interactive map
gps_path_selected <- gps_path_cleaned %>%
...
```{r, fig.cap="Facet graph of CarID 10 at 1800 (afterwork hours)"}
##Interactive map
gps_path_selected <- gps_path_cleaned %>%
...
```{r, fig.cap="Interactive graph of CarID 15 on 01/07/2014"}
##Interactive map
gps_path_selected <- gps_path_cleaned %>%
  filter(id == 15, day == 7)
...
```{r, fig.cap="Interactive graph of CarID 16 on 01/06/2014"}
##Interactive map
gps_path_selected <- gps_path_cleaned %>%
...
```{r, fig.cap="Facet graph of CarID 32 at 1700-1800 (afterwork hours)"}
##Interactive map
gps_path_selected <- gps_path_cleaned %>%
...
```{r, fig.cap="Interactive graph of CarID 15 on 01/09/2014"}
##Interactive map
gps_path_selected <- gps_path_cleaned %>%
  filter(id == 15, day == 9)
...
```{r, fig.cap="Interactive graph of CarID 24 on 01/08/2014"}
##Interactive map
gps_path_selected <- gps_path_cleaned %>%
...
```{r, fig.cap="Interactive graph of CarID 29 on 01/11/2014"}
##Interactive map
gps_path_selected <- gps_path_cleaned %>%
...
```{r, fig.cap="Facet graph of CarID 4 at 1700-1800 (afterwork hours)"}
##Interactive map
gps_path_selected <- gps_path_cleaned %>%
...
```{r, fig.cap="Interactive graph of CarID 16 on 01/10/2014, timegroup 2100-2400"}
##Interactive map
gps_path_selected <- gps_path_cleaned %>%
...
```{r, fig.cap="Interactive graph of CarID 24 on 01/14/2014"}
##Interactive map
gps_path_selected <- gps_path_cleaned %>%
  filter(id == 24, day == 14)
...
```{r, fig.cap="Interactive graph of CarID 21 on 01/11/2014"}
##Interactive map
gps_path_selected <- gps_path_cleaned %>%
  filter(id == 21, day == 11)
...
```{r, fig.cap="Graph of CarID 21 on 01/13/2014 and 01/14/2014"}
...
```{r, layout="l-body-outset", fig.width=6, fig.height=4, fig.cap="Facet graph of CarID 21 on from 1700-2400"}
##Facet map- by day
gps_path_selected <- gps_path_cleaned %>%
...
```{r, layout="l-body-outset", fig.width=6, fig.height=7, fig.cap="Facet graph of CarID 21 during 1200-1400"}
##Facet map- by id
gps_path_selected <- gps_path_cleaned %>%
...
```{r, layout="l-body-outset", fig.width=6, fig.height=7, fig.cap="Facet graph of CarID 33 during 1200-1400"}
##Facet map- by id
gps_path_selected <- gps_path_cleaned %>%
...
```{r, layout="l-body-outset", fig.width=6, fig.height=7, fig.cap="Facet graph of the various car trajectories during 1200-1300"}
##Facet map- by id
gps_path_selected <- gps_path_cleaned %>%
...
```{r, fig.cap="Interactive graph of CarID 1 on 01/13/2014 at 1300"}
##Interactive map
gps_path_selected <- gps_path_cleaned %>%
...
```{r, fig.cap="Interactive graph of CarID 24 on 01/13/2014 at 1200- 1300"}
##Interactive map
gps_path_selected <- gps_path_cleaned %>%
...
```{r, fig.cap="Interactive graph of CarID 29 on 01/11/2014 at 2200- 2400"}
##Interactive map
gps_path_selected <- gps_path_cleaned %>%
...
```{r, layout="l-body-outset", fig.width=6, fig.height=7, fig.cap="Facet graph of the various truck trajectories during 1700-2359"}
##Facet map- by day
gps_path_selected <- gps_path_cleaned %>%
...
```{r, layout="l-body-outset", fig.width=6, fig.height=7, fig.cap="Facet graph of CarID 32"}
##Facet map- by day
gps_path_selected <- gps_path_cleaned %>%
...
```{r, layout="l-body-outset", fig.width=6, fig.height=7, fig.cap="Facet graph of CarID 23"}
##Facet map- by day
gps_path_selected <- gps_path_cleaned %>%
...
```{r, layout="l-body-outset", fig.width=6, fig.height=7, fig.cap="Facet graph of CarID 1"}
##Facet map- by day
gps_path_selected <- gps_path_cleaned %>%
...
```{r, layout="l-body-outset", fig.width=6, fig.height=7, fig.cap="Facet graph of CarID 10"}
##Facet map- by day
gps_path_selected <- gps_path_cleaned %>%
...
```{r, fig.cap="Interactive graph of CarID 35 on 01/11/2014 at 1300- 1959"}
##Interactive map
gps_path_selected <- gps_path_cleaned %>%
...
```{r, fig.cap="Interactive graph of various car trajectories on 01/18/2014"}
##Interactive map
gps_path_selected <- gps_path_cleaned %>%
...
```{r, fig.cap="Interactive graph of various executives' car trajectories on 01/12/2014, 1200-1459"}
##Interactive map
gps_path_selected <- gps_path_cleaned %>%
...
```{r, fig.cap="Interactive graph of various executives' car trajectories on 01/19/2014, 1200-1359"}
##Interactive map
gps_path_selected <- gps_path_cleaned %>%
...
```{r, fig.cap="Interactive graph of CarID 31"}
##Interactive map
gps_path_selected <- gps_path_cleaned %>%
  filter(id == 31)
